...
try {
    & $csc /nologo /target:winexe /optimize+ /reference:System.Windows.Forms.dll /out:WhisperKey\config\EXPC-WLK.new.exe WhisperKey\config\PortableLauncher.cs WhisperKey\config\PortableVersion.generated.cs
    if ($LASTEXITCODE) { throw 'Launcher compilation failed' }
    & $csc /nologo /target:winexe /optimize+ /reference:System.Windows.Forms.dll /reference:System.Management.dll /out:WhisperKey\config\PortableUpdater.exe WhisperKey\config\PortableUpdater.cs
